...
with st.container():
    ...
    with right:
        ...
        st.write(
            "Hi, my name is Qiyao HE. Welcome! Welcome! Welcome! I built this webpage with self-learning knowledge so it looks not pretty and professional enough, please understand me. Super welcome to my page, if you want to know more about me, please explore on this page.")
    with left:
